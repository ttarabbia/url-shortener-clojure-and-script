...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27643 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27643(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27644 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27644(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27656 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27656(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27661 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27661(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27662 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27662(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27669 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27669(reader);
}
});
...
var G__27808 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27809 = s.append(c);
c = G__27808;
s = G__27809;
continue;
}
