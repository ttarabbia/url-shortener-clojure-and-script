...
var i_29989 = (self__.level + (1));
while(true){
if((i_29989 <= (new_level + (1)))){
(update[i_29989] = self__.header);

var G__29991 = (i_29989 + (1));
i_29989 = G__29991;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29992 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29992[i]));
} else {
x__$2.forward.push((((i < links_29992.length))?(links_29992[i]):null));
}

if((i < links_29992.length)){
(links_29992[i] = x__$2);
} else {
links_29992.push(x__$2);
}
...
var i_30000 = (0);
while(true){
if((i_30000 <= self__.level)){
var links_30001 = (update[i_30000]).forward;
if((x__$1 === (((i_30000 < links_30001.length))?(links_30001[i_30000]):null))){
(links_30001[i_30000] = (x__$1.forward[i_30000]));

var G__30002 = (i_30000 + (1));
i_30000 = G__30002;
continue;
} else {
var G__30003 = (i_30000 + (1));
i_30000 = G__30003;
continue;
}
} else {
...
var G__30017 = nx;
var G__30019 = (level__$1 - (1));
x = G__30017;
level__$1 = G__30019;
continue;
} else {
var G__30024 = x;
var G__30025 = (level__$1 - (1));
x = G__30024;
level__$1 = G__30025;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30033 = nx;
var G__30034 = (level__$1 - (1));
x = G__30033;
level__$1 = G__30034;
continue;
} else {
var G__30036 = x;
var G__30037 = (level__$1 - (1));
x = G__30036;
level__$1 = G__30037;
continue;
}
