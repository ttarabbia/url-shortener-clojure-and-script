...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27765 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27765(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27773 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27773(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27782 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27782(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27812 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27812(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27825 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27825(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27840 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27840(reader);
}
});
...
var G__28038 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28039 = s.append(c);
c = G__28038;
s = G__28039;
continue;
}
