...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30841 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30841(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30846 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30846(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30848 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30848(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30854 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30854(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30855 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30855(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30856 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30856(reader);
}
});
...
var G__30905 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30906 = s.append(c);
c = G__30905;
s = G__30906;
continue;
}
