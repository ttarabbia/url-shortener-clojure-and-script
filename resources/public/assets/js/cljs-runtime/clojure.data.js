...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__29754){
var vec__29757 = p__29754;
...
var vec__29775 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29775,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29775,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29775,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29903 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29903(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_29908 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_29908(a,b);
}
});
...
var fexpr__29882 = (function (){var G__29883 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29883__$1)].join('')));

}
})();
return (fexpr__29882.cljs$core$IFn$_invoke$arity$2 ? fexpr__29882.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__29882.call(null,a,b));
}));
/**
