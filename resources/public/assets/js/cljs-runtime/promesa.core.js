...
try{var G__39646_39726 = (function (p1__39639_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__39639_SHARP_);
});
var G__39647_39727 = (function (p1__39640_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__39640_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__39646_39726,G__39647_39727) : f.call(null,G__39646_39726,G__39647_39727));
}catch (e39645){var e_39728 = e39645;
promesa.protocols._reject_BANG_(d,e_39728);
}
return d;
}));
...
try{var G__39649 = (function (p1__39641_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__39641_SHARP_);
});
var G__39650 = (function (p1__39642_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__39642_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__39649,G__39650) : f.call(null,G__39649,G__39650));
}catch (e39648){var e = e39648;
...
var len__5769__auto___39735 = arguments.length;
var i__5770__auto___39736 = (0);
while(true){
if((i__5770__auto___39736 < len__5769__auto___39735)){
args_arr__5794__auto__.push((arguments[i__5770__auto___39736]));

var G__39737 = (i__5770__auto___39736 + (1));
i__5770__auto___39736 = G__39737;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39662_SHARP_,p2__39663_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__39662_SHARP_,p2__39663_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq39665){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39666,G__39667,seq39665__$2);
}));
...
args_arr__5794__auto__.push((arguments[i__5770__auto___39740]));
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq39670){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39671,G__39672,seq39670__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__39678_SHARP_){
return (p1__39678_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__39681_SHARP_){
return (p1__39681_SHARP_ instanceof pred_or_type);
}));
...
var seq__39688 = cljs.core.seq(promises);
var chunk__39689 = null;
var count__39690 = (0);
var i__39691 = (0);
while(true){
if((i__39691 < count__39690)){
var p = chunk__39689.cljs$core$IIndexed$_nth$arity$2(null,i__39691);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__39688,chunk__39689,count__39690,i__39691,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__39688,chunk__39689,count__39690,i__39691,p,state){
...
});})(seq__39688,chunk__39689,count__39690,i__39691,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__39688,chunk__39689,count__39690,i__39691,p,state))
),((function (seq__39688,chunk__39689,count__39690,i__39691,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__39688,chunk__39689,count__39690,i__39691,p,state){
return (function (state__$1){
...
var map__39696 = cljs.core.deref(state);
var map__39696__$1 = cljs.core.__destructure_map(map__39696);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39696__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__39697 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__39697) : reject.call(null,G__39697));
} else {
...
var G__39748 = seq__39688;
var G__39749 = chunk__39689;
var G__39750 = count__39690;
var G__39751 = (i__39691 + (1));
seq__39688 = G__39748;
chunk__39689 = G__39749;
count__39690 = G__39750;
i__39691 = G__39751;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__39688);
if(temp__5804__auto__){
var seq__39688__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__39688__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__39688__$1);
var G__39752 = cljs.core.chunk_rest(seq__39688__$1);
var G__39753 = c__5568__auto__;
var G__39754 = cljs.core.count(c__5568__auto__);
var G__39755 = (0);
seq__39688 = G__39752;
chunk__39689 = G__39753;
count__39690 = G__39754;
i__39691 = G__39755;
continue;
} else {
var p = cljs.core.first(seq__39688__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state))
),((function (seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__39688,chunk__39689,count__39690,i__39691,p,seq__39688__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__39698 = cljs.core.deref(state);
var map__39698__$1 = cljs.core.__destructure_map(map__39698);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39698__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39698__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39698__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__39699 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__39699) : reject.call(null,G__39699));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__39756 = cljs.core.next(seq__39688__$1);
var G__39757 = null;
var G__39758 = (0);
var G__39759 = (0);
seq__39688 = G__39756;
chunk__39689 = G__39757;
count__39690 = G__39758;
i__39691 = G__39759;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39700_SHARP_,p2__39701_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__39700_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__39701_SHARP_) : f.call(null,p2__39701_SHARP_));
}));
