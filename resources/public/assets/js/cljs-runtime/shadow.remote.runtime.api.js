...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35299 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35299(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35301 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35301(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35304 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35304(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35308 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35308(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35309 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35309(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35310 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35310(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35288,callback){
var map__35290 = p__35288;
var map__35290__$1 = cljs.core.__destructure_map(map__35290);
var input = map__35290__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35290__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35290__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
