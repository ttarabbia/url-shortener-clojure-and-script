...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30530 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30530(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30539 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30539(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30549 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30549(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30555 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30555(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30557 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30557(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30561 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30561(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30510,callback){
var map__30512 = p__30510;
var map__30512__$1 = cljs.core.__destructure_map(map__30512);
var input = map__30512__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30512__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30512__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
