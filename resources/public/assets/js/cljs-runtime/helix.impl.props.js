...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__40428_SHARP_,p2__40427_SHARP_){
return p2__40427_SHARP_.toUpperCase();
}));
...
var G__40443 = o;
helix.impl.props.goog$module$goog$object.set(G__40443,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__40489 = cljs.core.rest(m);
var G__40490 = (function (){var entry = cljs.core.first(m);
...
var G__40469 = o1;
helix.impl.props.goog$module$goog$object.extend(G__40469,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40479_SHARP_){
if(cljs.core.map_QMARK_(p1__40479_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__40479_SHARP_);
} else {
return p1__40479_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__40493 = cljs.core.rest(m);
var G__40494 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__40497 = cljs.core.rest(m);
var G__40498 = (function (){var entry = cljs.core.first(m);
