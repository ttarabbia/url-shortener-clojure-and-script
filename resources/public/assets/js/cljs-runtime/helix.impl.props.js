...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__27759_SHARP_,p2__27758_SHARP_){
return p2__27758_SHARP_.toUpperCase();
}));
...
var G__27760 = o;
helix.impl.props.goog$module$goog$object.set(G__27760,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__27784 = cljs.core.rest(m);
var G__27785 = (function (){var entry = cljs.core.first(m);
...
var G__27775 = o1;
helix.impl.props.goog$module$goog$object.extend(G__27775,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27776_SHARP_){
if(cljs.core.map_QMARK_(p1__27776_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__27776_SHARP_);
} else {
return p1__27776_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__27788 = cljs.core.rest(m);
var G__27789 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__27794 = cljs.core.rest(m);
var G__27795 = (function (){var entry = cljs.core.first(m);
